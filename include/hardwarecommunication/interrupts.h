...
#ifndef INCLUDE_HARDWARECOMMUNICATION_INTERRUPTS
#define INCLUDE_HARDWARECOMMUNICATION_INTERRUPTS
...
protected:
  ...
  static myos::common::uint32_t
  HandleInterrupt (myos::common::uint8_t interrupt,
                   myos::common::uint32_t esp);
  myos::common::uint32_t DoHandleInterrupt (myos::common::uint8_t interrupt,
                                            myos::common::uint32_t esp);
...
#endif /* INCLUDE_HARDWARECOMMUNICATION_INTERRUPTS */
